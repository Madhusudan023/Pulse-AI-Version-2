package com.pulseai.employeeservice.security;

import com.pulseai.employeeservice.constants.SecurityConstants;
import com.pulseai.employeeservice.util.JwtUtil;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (jwt != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            if (jwtUtil.validateToken(jwt)) {
                ...
                // Keep original string for controller to read if necessary, but use ROLE_ prefixed for authority
                ...
                UsernamePasswordAuthenticationToken authToken = new UsernamePasswordAuthenticationToken(
                        employeeId, null, Collections.singletonList(new SimpleGrantedAuthority(authorityRole)));
