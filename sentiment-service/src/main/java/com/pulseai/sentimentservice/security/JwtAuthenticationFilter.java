package com.pulseai.sentimentservice.security;

import com.pulseai.sentimentservice.constants.SecurityConstants;
import com.pulseai.sentimentservice.util.JwtUtil;
        ...
        if (jwt != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            if (jwtUtil.validateToken(jwt)) {
                ...
                UsernamePasswordAuthenticationToken authToken = new UsernamePasswordAuthenticationToken(
                        employeeId, null, Collections.singletonList(new SimpleGrantedAuthority(role.startsWith("ROLE_") ? role : "ROLE_" + role)));
