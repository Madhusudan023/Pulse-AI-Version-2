package com.pulseai.sentimentservice.exception;

import com.pulseai.sentimentservice.dto.ApiResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleException(Exception ex) {
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(ApiResponse.<Void>builder().success(false).message(msg).traceId(java.util.UUID.randomUUID().toString()).build());
    }
